...
/*  добавить margin top для текста после слайдера в секции HOME*/
$(document).ready(function () {
    calculateMargin();
    $(window).resize(function () {
        calculateMargin();
     });
    $('#home #promo-slider').resize(function() {
        calculateMargin();
    });
});
var BREAKE_POINT = 768,
    homeSlider,
    homeSliderHeight,
    homeH1,
    homeH1Height,
    ...
    function calculateMargin() {
        homeH1 = $('#home #promo-text h1');
        divMargin = $('#home #promo-text h6');
        homeSlider = $('#home #promo-slider');
        if ($(window).width() < BREAKE_POINT) {
            homeSliderHeight = homeSlider.height();
            homeH1Height = homeH1.height();
            var margin = homeSliderHeight + 100;
            homeSlider.css('top', homeH1Height);
            divMargin.css('margin-top', margin);
        } else {
            divMargin.css('margin-top', '0');
...
$(document).ready(function () {
    $('.span-light').hover(
    function() {
        $('.promo-button').find('.buy-now').css('background-color', '#ff00d2');
        $('.promo-button').find('.buy-now').css('color', '#fff');
    },
    function() {
        $('.promo-button').find('.buy-now').css('background-color', '#390037');
        $('.promo-button').find('.buy-now').css('color', '#ff00d2');
    });

    $('.promo-button .buy-now').hover(
        function() {
            $(this).css('background-color', '#ff00d2');
            $(this).css('color', '#fff');
            console.log('hello');
        },
        function() {
            $(this).css('background-color', '#390037');
            $(this).css('color', '#ff00d2');
        } 
